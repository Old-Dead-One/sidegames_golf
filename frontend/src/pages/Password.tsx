                                ...
                                <div className="py-1">
                                    ...
                                    <div className="text-xs flex flex-col">
                                        <div className="relative">
                                            {(focusedField === 'current-password' || currentPassword) && (
                                                <label htmlFor="current-password" className="absolute -top-4 left-3 px-1 text-xs bg-neutral-500 text-white">
                                                    Current Password
                                                </label>
                                            )}
                                            <div className="flex rounded-lg relative">
                                                ...
                                                <button
                                                    type="button"
                                                    className="text-xs absolute right-2 top-1/2 -translate-y-1/2"
                                                    tabIndex={-1}
                                        ...
                                        <div className="relative mt-4">
                                            {(focusedField === 'new-password' || newPassword) && (
                                                <label htmlFor="new-password" className="absolute -top-4 left-3 px-1 text-xs bg-neutral-500 text-white">
                                                    New Password
                                                </label>
                                            )}
                                            <div className="flex rounded-lg relative">
                                        ...
                                        <div className="relative mt-4">
                                            {(focusedField === 'confirm-password' || confirmPassword) && (
                                                <label htmlFor="confirm-password" className="absolute -top-4 left-3 px-1 text-xs bg-neutral-500 text-white">
                                                    Confirm Password
                                                </label>
                                            )}
                                            <div className="flex rounded-lg relative">
